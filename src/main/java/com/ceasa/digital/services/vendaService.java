            ...
            if (!validaExistenciaOferta.isEmpty()) {
                ...
                if (validaExistenciaOferta.get().getQtdDisponivel() >= qtd) {
                    ...
                    if (validaExistenciaOferta.get().getIdVendedor() != idComprador) {
                        ...
                        Optional<vendaModel> validaExistenciaNegociacao = vRepository
                                .findByIdCompradorAndIdOfertaAndVendaStatus(idComprador, idOferta,
                                        vendaNegociacaoStatusEnum.EM_ANDAMENTO.getValue());
                        ...
                        if (validaExistenciaNegociacao.isEmpty()) {
                            ...
                            Optional<vendaModel> vModelNeg = vRepository
                                    .findByIdCompradorAndIdOfertaAndVendaStatus(idComprador, idOferta, "PROCESSO");
                            ...
                            String message = "Ola, " + Vendedor.getNome().toString() + ". \r\nO nosso parceiro "
                                    + Comprador.getNome().toString() + " demonstrou interesse na sua oferta de: *"
