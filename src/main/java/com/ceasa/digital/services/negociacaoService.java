...
public class negociacaoService {
    ...
    public httpResponses processoCancelamento(int idVenda, int idUsuario) {
        ...
        if (!validaExistenciaVenda.isEmpty() && (validaExistenciaVenda.get().getIdComprador() == idUsuario
            ...
            if (!verificaNegociacao.get().getstatusNegociacao()
                    .equals(vendaNegociacaoStatusEnum.EM_ANDAMENTO.getValue())) {

                if (verificaNegociacao.get().getstatusNegociacao()
                        .equals(vendaNegociacaoStatusEnum.CANCELADO.getValue())) {
            ...
            if (validaExistenciaVenda.get().getIdComprador() == idUsuario) {
                ...
                if (verificaNegociacao.get().isAprovacao_vendedor() == false) {
                    ...
                    objNegociacao.setSubStatusNegociacao(
                            negociacaoSubStatusEnum.AGUARDANDO_APROVACAO_Vendedor_CANCELAMENTO.getValue());
                ...
                if (verificaNegociacao.get().isAprovacao_vendedor() == true) {
                    ...
                    userModel Comprador = uService.recuperaUsuariobyId(validaExistenciaVenda.get().getIdComprador())
                            .get();
                    produtoModel produto = pRepository.findById(
                            ofertaRepository.findById(validaExistenciaVenda.get().getIdOferta()).get().getIdProduto())
                            .get();
                    String message = "Ola, " + Vendedor.getNome().toString() + ". \r\n seu processo negocial com "
                            + Comprador.getNome().toString() + " relacionado a venda de: *"
                    ...
                    message = "Ola, " + Comprador.getNome().toString() + ". \r\n seu processo negocial com "
                            + Vendedor.getNome().toString() + " relacionado a compra de: *"
                            + produto.getNome().toString() + "* foi canceladi com sucesso." + appLink
                            + "\r\n\r\nAtenciosamente,\r\n*Equipe Ceasa Digital*";
                ...
                if (verificaNegociacao.get().isAprovacao_comprador() == false) {
                    ...
                    objNegociacao.setSubStatusNegociacao(
                            negociacaoSubStatusEnum.AGUARDANDO_APROVACAO_Comprador_CANCELAMENTO.getValue());
                ...
                if (verificaNegociacao.get().isAprovacao_vendedor() == true) {
                    ...
                    message = "Ola, " + Comprador.getNome().toString() + ". \r\nseu processo negocial com "
                            + Comprador.getNome().toString() + " relacionado a compra de: *"
                            + produto.getNome().toString()
                            + "* foi cancelado com sucesso.\r\n\r\nAtenciosamente,\r\n*Equipe Ceasa Digital*";
            ...
            if (nRepository.findByidVenda(idVenda).get().getstatusNegociacao()
                    .equalsIgnoreCase(vendaNegociacaoStatusEnum.CANCELADO.getValue())) {

                return negociacaoResponsesEnum.nCancelado.getResponseObject();
            }

            if (nRepository.findByidVenda(idVenda).get().getstatusNegociacao()
                    .equalsIgnoreCase(vendaNegociacaoStatusEnum.CONCLUIDO.getValue())) {
        ...
        if (!validaExistenciaVenda.isEmpty() && (validaExistenciaVenda.get().getIdComprador() == idUsuario
            ...
            if (validaExistenciaVenda.get().getIdComprador() == idUsuario) {
                ...
                if (verificaNegociacao.get().isAprovacao_vendedor() == false) {
                    ...
                    objNegociacao.setSubStatusNegociacao(
                            negociacaoSubStatusEnum.AGUARDANDO_APROVACAO_CONCLUSAO_Vendedor.getValue());
   ...
   oRepository.save(oferta);
                ...
                if (verificaNegociacao.get().isAprovacao_comprador() == false) {
                    ...
                    objNegociacao.setSubStatusNegociacao(
                            negociacaoSubStatusEnum.AGUARDANDO_APROVACAO_CONCLUSAO_Comprador.getValue());
